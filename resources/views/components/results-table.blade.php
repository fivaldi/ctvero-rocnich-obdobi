...
<tr style="background-color: silver">
    <th class="col-1{{ $terse? ' d-none d-md-table-cell' : '' }}">Pořadí</th>
    <th class="col-1 d-none d-{{ $terse? 'lg' : 'md' }}-table-cell">Datum hlášení</th>
    <th class="col-8">
        <div class="row">
            <div class="d-inline d-{{ $terse? 'md' : 'sm' }}-table-cell col-12 col-{{ $terse? 'md' : 'sm' }}-6">Volačka</div>
            <div class="d-inline d-{{ $terse? 'md' : 'sm' }}-table-cell col-{{ $terse? 'md' : 'sm' }}-6 qth-name-{{ $terse? 'md' : 'sm' }}">QTH</div>
        </div>
    </th>
    <th class="col-1 d-none d-{{ $terse? 'lg' : 'md' }}-table-cell">Lokátor</th>
